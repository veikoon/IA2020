import pacman
from pacman.problems import FoodSearchProblem, PositionSearchProblem
from ex03 import astar_search


def manhattan_distance(start, goal, problem=None):
...
if __name__ == '__main__':
    pacman.run(astar_search, problem=FoodSearchProblem, heuristic=foodHeuristic)