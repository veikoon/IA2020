...
import time, random
from pacman.game import Directions, Agent
...
class SearchAgent(Agent):
    ...
    def __init__(self, search, problem, heuristic=None, costFn=None, **kwargs):
        ...
        if 'costFn' in problem.__init__.__code__.co_varnames:
            if 'display' in problem.__init__.__code__.co_varnames:
                args = dict(costFn=costFn, display=kwargs['display'])
            else:
